...
<details><summary>#3 Front-User Profile</summary>
  ...
  |구현|구현 중점|날짜|Dev|
  |--|--|--|--|
  ||그래프와 테이블을 세로가 아닌 가로로 변경|2022-04-06|'S'|
  |||||
  ...
  |table태그 안 2단 maping에 의한<br>리액트 구조 문제|이미지를 table태그 안에 넣을 경우 2단 maping과<br>thead와 tbody가 강제되는 리액트 특성이 존재해<br>그래프를 이미지로 테이블에 넣지않고|2022-04-06|`S`|

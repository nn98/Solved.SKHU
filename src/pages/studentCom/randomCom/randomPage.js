...
import ProCard from '../algoCom/proCard';
    ...
    return (
        <div>
            <div style={{ position: 'relative', width : '100vw', height : '90vh', overflow : 'hidden',}}>  
                ...
                />
                <div style={{position:'absolute',width:"40%",height:"100%" ,left:"25%",opacity:`${time}`, transition:"opacity 0.3s ease 0.3s"}}>
                    <ProCard  top={"25vh"}fontSize={"2rem"} proTier={'13'} proColor={'#ec9a00'} width={"100%"} height={"40%"}/>
                </div>
            </div>
        </div>
    );
